    ...
    inputSchema: {
      ...
      properties: {
        ...
        openInBrowser: {
          type: "boolean",
          description:
            "render only (requires writeHtml): also open the generated HTML in the user's default browser automatically. Default: false.",
        },
      },
