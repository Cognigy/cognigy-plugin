        ...
        config: {
          ...
          properties: {
            ...
            preProcessCode: {
              type: "string",
              description:
                "JavaScript code to run BEFORE the HTTP request. Runs in Cognigy's Code Node environment with access to input, context, profile and api (http only). Rejected if it uses anything the Code Node runtime does not have: api.httpRequest(), fetch()/XMLHttpRequest, require()/import (modules are globals: moment, _, xmljs, getTextCleaner), or the removed api.setState/getState/resetState.",
            },
            postProcessCode: {
              type: "string",
              description:
                "JavaScript code to run AFTER the HTTP response. Runs in Cognigy's Code Node environment with access to input, context, profile and api (http only). Same runtime constraints as preProcessCode.",
            },
            toolResponseValue: {
              type: "string",
              description:
        ...
        config: {
          ...
          properties: {
            ...
            preProcessCode: {
              type: "string",
              description:
                "JavaScript code for the pre-process Code node (http only). Same runtime constraints as create_tool's preProcessCode; rejected before anything is written if violated.",
            },
            postProcessCode: {
              type: "string",
              description:
                "JavaScript code for the post-process Code node (http only). Same runtime constraints as preProcessCode.",
            },
            toolResponseValue: {
              type: "string",
              description:
