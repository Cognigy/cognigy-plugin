    ...
    inputSchema: {
      ...
      properties: {
        ...
        isDisabled: {
          type: "boolean",
          description:
            "update only: true disables the node (the flow skips it at runtime, it stays in the chart); false re-enables it. Can be sent alone or together with label/config.",
        },
        focus: {
          oneOf: [
            { type: "string" },
