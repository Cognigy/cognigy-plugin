    ...
    inputSchema: {
      ...
      properties: {
        ...
        focus: {
          type: "string",
          description:
            "render only: node ID to highlight in the diagram (e.g. a node you just created or edited).",
        },
        format: {
          type: "string",
