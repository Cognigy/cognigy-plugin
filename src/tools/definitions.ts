    ...
    inputSchema: {
      ...
      properties: {
        ...
        writeHtml: {
          type: "boolean",
          description:
            "render only: also write a self-contained rich HTML graph to a tmp file and return its htmlUrl (open in a browser). Default: false.",
        },
      },
